...
class ConfTestCase(base.BaseTestCase):
    ...
    def test_import_mods_no_func(self):
        ...
        with mock.patch('importlib.import_module') as mock_import:
            ...
            mock_import.assert_called_once_with('datahub.conf.foo')
    ...
    def test_import_mods_valid_func(self):
        ...
        with mock.patch('importlib.import_module') as mock_import:
            ...
            mock_import.assert_has_calls([mock.call('datahub.conf.foo'),
                                          mock.call('datahub.conf.bar')])
